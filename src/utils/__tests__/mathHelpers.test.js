...
describe("mathHelpers", () => {
  ...
  test("returns expected initial values for fourth diffEq", () => {
    ...
    const results = [
      [
        { x: 0, y: 4 },
        { x: 0.1, y: 3.5660564400304957 },
        { x: 0.2, y: -1.1050439127302332 },
        { x: 0.30000000000000004, y: -3.5020082287704746 },
        { x: 0.4, y: -3.358389552923307 },
        { x: 0.5, y: -0.1461549830189134 },
        { x: 0.6, y: 2.3454604481598778 },
        { x: 0.7, y: 2.9678576281823426 },
        { x: 0.7999999999999999, y: 2.825674725073134 },
        { x: 0.8999999999999999, y: 0.7835175295652342 },
        { x: 0.9999999999999999, y: -0.8523687489226963 },
        { x: 1.0999999999999999, y: -1.8973297201018422 },
        { x: 1.2, y: -2.2037596286781636 },
        { x: 1.3, y: -2.4530368226708443 },
        { x: 1.4000000000000001, y: -2.2283992794860144 },
        { x: 1.5000000000000002, y: -1.151187621681231 },
        { x: 1.6000000000000003, y: -0.32274164079658174 },
        { x: 1.7000000000000004, y: 0.10725474008562604 },
        { x: 1.8000000000000005, y: 0.36463504263921553 },
        { x: 1.9000000000000006, y: 0.5472494761059066 }
      ],
      [
        { x: 0, y: -2 },
        { x: 0.1, y: 4.1361402276805235 },
        { x: 0.2, y: 4.235273785202366 },
        { x: 0.30000000000000004, y: 1.1540187107627904 },
        { x: 0.4, y: -3.3060287113000983 },
        { x: 0.5, y: -3.747888537323594 },
        { x: 0.6, y: -2.681816259782223 },
        { x: 0.7, y: 0.06111468955368018 },
        { x: 0.7999999999999999, y: 2.8616272262626374 },
        { x: 0.8999999999999999, y: 3.192936167725381 },
        { x: 0.9999999999999999, y: 2.631391630926809 },
        { x: 1.0999999999999999, y: 1.811399325727445 },
        { x: 1.2, y: 0.44034922921138964 },
        { x: 1.3, y: -1.029882926537778 },
        { x: 1.4000000000000001, y: -2.416687200905085 },
        { x: 1.5000000000000002, y: -2.556456697661914 },
        { x: 1.6000000000000003, y: -2.0203351362403468 },
        { x: 1.7000000000000004, y: -1.6266544246990213 },
        { x: 1.8000000000000005, y: -1.4140162778306342 },
        { x: 1.9000000000000006, y: -1.269321126796787 }
      ]
    ];
    data[0].forEach((d, i) => {
      expect(d.x).toBeCloseTo(results[0][i].x);
