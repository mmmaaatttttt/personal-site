...
const Terms = () => (
  <StyledTermsSection>
    ...
    <p>
      ...
      <a href="https://mattlane.us">https://mattlane.us</a>, you are agreeing to
    ...
    <ol type="a">
      <li>
        ...
        (information or software) on Matt Lane's website for personal,
      ...
      <li>
        ...
        restrictions and may be terminated by Matt Lane at any time. Upon
    ...
    <ol type="a">
      <li>
        The materials on Matt Lane's website are provided on an 'as is' basis.
        Matt Lane makes no warranties, expressed or implied, and hereby
      ...
      <li>
        Further, Matt Lane does not warrant or make any representations
    ...
    <h3>4. Limitations</h3>
    <p>
      In no event shall Matt Lane or its suppliers be liable for any damages
      ...
      materials on Matt Lane's website, even if Matt Lane or a Matt Lane
    ...
    <p>
      The materials appearing on Matt Lane website could include technical,
      typographical, or photographic errors. Matt Lane does not warrant that any
      of the materials on its website are accurate, complete or current. Matt
      Lane may make changes to the materials contained on its website at any
      time without notice. However Matt Lane does not make any commitment to
      update the materials.
    </p>
    <h3>6. Links</h3>
    <p>
      Matt Lane has not reviewed all of the sites linked to its website and is
      not responsible for the contents of any such linked site. The inclusion of
      any link does not imply endorsement by Matt Lane of the site. Use of any
      such linked website is at the user's own risk.
    </p>
    <h3>7. Modifications</h3>
    <p>
      Matt Lane may revise these terms of service for its website at any time
    ...
    <p>
      Your privacy is important to us. It is Matt Lane's policy to respect your
      privacy regarding any information we may collect from you across our
      website, https://mattlane.us.
    </p>
    <p>
      We don’t ask for your personal information unless we truly need it. When
      we do, we’ll only collect what we need by fair and lawful means and, where
      appropriate, with your knowledge or consent. We’ll also let you know why
      we’re collecting it and how it will be used.
    </p>
    <p>
      We don’t share your personal information with third-parties, except where
    ...
    <p>
      ...
      within commercially acceptable means to protect your personal information
      from loss or theft, as well as unauthorized access, disclosure, copying,
      use or modification.
    </p>
  </StyledTermsSection>
);
