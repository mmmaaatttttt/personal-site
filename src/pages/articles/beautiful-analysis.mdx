...
<CaptionWrapper caption="Figure 8: wut.">
  <HorizontalBarGraph
...
While we're in the land of machine learning,

<Quiz
  answerColors={[COLORS.DARK_BLUE, COLORS.PURPLE]}
  caption="Figure 9: byeee"
  questionData={baQuizData}
  title="Who said it: Chris Gethard or a Machine?"
/>

But don't worry Gethard: the robots aren't coming for your job anytime soon. I
intentionally selected the cream of the algorithm-generated crop. There was
plenty of text that was pretty clearly nonsense. Here's a small sample:
