...
<PAdicHeatChart caption="Figure 6: A heat chart of p-adic distances for numbers between 1 and 50. The darker the square, the closer the distance to 1. The lighter the square, the closer the distance to 0. Hover over a square to see the numbers and their distance."/>
...
<PAdicFractalDistance caption="Figure 7: Foo" />
...
https://www.jstor.org/stable/2323809?read-now=1&seq=10#page_scan_tab_contents
http://math.uni.lu/eml/projects/reports/P-adics.pdf
https://www.google.com/search?q=number+theory+as+the+ultimate+physical+theory&oq=Number+theory+as+the+ultimate+physical+theory&aqs=chrome.0.0.366j0j1&sourceid=chrome&ie=UTF-8
