...
title: "Warming Dots"
date: "2018-07-19"
featured_image: "../../images/featured_images/warming_dots.png"
...
![Can you find the pale blue dot?](../../images/pale_blue_dot.png "Can you find the pale blue dot? (Source: NASA)"){.w-80}
...
<WarmingDots
  index={0}
  caption="Figure 1: An exponential model of population growth."
/>
...
<WarmingDots
  index={1}
  caption="Figure 2: A logistic model of population growth."
/>
...
<WarmingDots
  index={2}
  caption="Figure 3: Modeling Population along with the environment."
/>
...
<WarmingDots
  index={3}
  caption="Figure 4: Modeling environment and population with two resources."
/>
...
<WarmingDots
  vizIndex="4"
  caption="Figure 5: Including an environmental fragility parameter into the model."
/>
