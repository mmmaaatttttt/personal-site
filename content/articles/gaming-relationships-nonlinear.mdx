...
<GamingRelationships
  visData={nonlinearVisData[0]}
  step={0.02}
  caption="Figure 1: On the left, our linear model from before; on the right, a new and nonlinear model."
/>
...
<GamingRelationships
  visData={nonlinearVisData[1]}
  step={0.02}
  caption="Figure 2: Chaotic relationship dynamics between three people."
  max={40}
/>
