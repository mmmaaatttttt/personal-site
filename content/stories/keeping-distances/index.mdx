...
import ManhattanCircle from "./components/ManhattanCircle";
import ManhattanPaths from "./components/ManhattanPaths";
import StringDistanceExplorer from "./components/StringDistanceExplorer";
import FunctionDistanceExplorer from "./components/FunctionDistanceExplorer";
import PAdicCalculator from "./components/PAdicCalculator";
import PAdicHeatChart from "./components/PAdicHeatChart";
import PAdicFractalDistance from "./components/PAdicFractalDistance";
...
<DistanceExplorer caption="Adjust the positions of the two points to see the shortest distance between them (orange)." />
...
<ManhattanPaths caption="Click on a point on the grid, then adjust the slider to see all possible shortest paths to that point." />
...
<ManhattanCircle caption="Move the slider to adjust the size of a circle in the taxicab geometry. The red dot is at the center of the circle." />
...
<StringDistanceExplorer caption="Enter two words to compare their Hamming, Levenshtein, and Damerau-Levenshtein distances." />
...
<FunctionDistanceExplorer caption="Drag the control points to reshape the two functions. Toggle between the largest-difference and area measures." />
...
<PAdicCalculator caption="Select a prime and enter two integers to see their p-adic distance." />
...
<PAdicHeatChart caption="Select a prime and hover over a cell to see the p-adic distance between two numbers from 1 to 25." />
