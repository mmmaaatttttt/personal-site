...
<Figure caption="Adjust the positions of the two points to see the shortest distance between them (orange).">
  <DistanceExplorer />
</Figure>
...
<Figure caption="Click on a point on the grid, then adjust the slider to see all possible shortest paths to that point.">
  <ManhattanPaths />
</Figure>
...
<Figure caption="Move the slider to adjust the size of a circle in the taxicab geometry. The red dot is at the center of the circle.">
  <ManhattanCircle />
</Figure>
...
<Figure caption="Enter two words to compare their Hamming, Levenshtein, and Damerau-Levenshtein distances.">
...
<Figure caption="Drag the control points to reshape the two functions. Toggle between the largest-difference and area measures.">
...
<Figure caption="Select a prime and enter two integers to see their p-adic distance.">
  <PAdicCalculator />
</Figure>
...
<Figure caption="Select a prime and hover over a cell to see the p-adic distance between two numbers from 1 to 25.">
  <PAdicHeatChart />
</Figure>
