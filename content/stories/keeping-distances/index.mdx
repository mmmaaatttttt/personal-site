...
<StringDistanceExplorer caption="Figure 4: Enter two words to compare their Hamming, Levenshtein, and Damerau-Levenshtein distances." />
...
<FunctionDistanceExplorer caption="Figure 5: Drag the control points to reshape the two functions. Toggle between the largest-difference and area measures." />
...
<PAdicCalculator caption="Figure 6: Select a prime and enter two integers to see their p-adic distance." />
...
<PAdicHeatChart caption="Figure 7: Select a prime and hover over a cell to see the p-adic distance between two numbers from 1 to 25." />
...
<PAdicFractalDistance caption="Figure 8: Adjust the level slider and select a prime to see how numbers cluster under the p-adic distance." />
