...
<WedgeExplorer caption="Figure 4: Share of jobs automated vs. number of firms. As the number of firms increases, so too does the amount of excessive automation." />
