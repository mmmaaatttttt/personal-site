import LinearGamingRelationships from "./components/LinearGamingRelationships";
...
<ResponsiveIFrame
  src="https://www.youtube.com/embed/Vg-zC1xXK3E"
  heightOverWidth={42 / 56}
/>
...
<Figure caption="Visualizing A and B's feelings based on four inputs.">
  <LinearGamingRelationships idx={0} />
</Figure>
...
<Figure caption="Visualizing A and B's feelings based on six inputs.">
  <LinearGamingRelationships idx={1} />
</Figure>
...
<Figure caption="Visualizing A and B's feelings based on eight inputs.">
  <LinearGamingRelationships idx={2} />
</Figure>
...
<Latex
  displayMode={true}
  str={`\\begin{aligned} A^{\\prime} (t) &= a \\times B(t) + c \\times A(t) + e \\times B_{appeal}, \\\\ B^{\\prime} (t) &= b \\times A(t) + d \\times B(t) + f \\times A_{appeal}, \\end{aligned}`}
/>
