...
<LinearGamingRelationships
  idx={0}
  caption="Figure 1: Visualizing A and B's feelings based on four inputs."
/>
...
<LinearGamingRelationships
  idx={1}
  caption="Figure 2: Visualizing A and B's feelings based on six inputs."
/>
...
<LinearGamingRelationships
  idx={2}
  caption="Figure 3: Visualizing A and B's feelings based on eight inputs."
/>
