...
<LinearGamingRelationships
  idx={0}
  caption="Visualizing A and B's feelings based on four inputs."
/>
...
<LinearGamingRelationships
  idx={1}
  caption="Visualizing A and B's feelings based on six inputs."
/>
...
<LinearGamingRelationships
  idx={2}
  caption="Visualizing A and B's feelings based on eight inputs."
/>
