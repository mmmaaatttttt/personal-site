import WarmingDots from "./components/WarmingDots";
...
![Can you find the pale blue dot?](../../images/pale_blue_dot.png "Can you find the pale blue dot? (Source: NASA)")
...
<Figure caption="An exponential model of population growth.">
  <WarmingDots vizIndex={0} />
</Figure>
...
<Figure caption="A logistic model of population growth.">
  <WarmingDots vizIndex={1} />
</Figure>
...
2.  The additional growth rate of the population produced by harvesting the resource.
3.  The carrying capacity of the environment in its natural state, that is, when the environmental health metric is 0 (this is the same parameter as in the logistic function.)
...
5.  The recovery rate of the environment. In other words, in the absence of people, this measures how quickly the environment reverts to its natural state.
6.  The rate of harm to the environment caused by harvesting resources. The idea here is that this is a scale factor based on the population: the higher the population, the more resources are harvested, and the more harm is done to the environment. The larger this factor, the more harm is done per person.

Whew. That's a lot. But with all of this setup, we're finally ready to explore our third model. Here it is.

<Figure caption="Modeling Population along with the environment.">
  <WarmingDots vizIndex={2} />
</Figure>
...
<Figure caption="Modeling environment and population with two resources.">
  <WarmingDots vizIndex={3} />
</Figure>
...
<Figure caption="Including an environmental fragility parameter into the model.">
  <WarmingDots vizIndex={4} />
</Figure>
