...
<WarmingDots
  vizIndex={0}
  caption="An exponential model of population growth."
/>
...
<WarmingDots
  vizIndex={1}
  caption="A logistic model of population growth."
/>
...
<WarmingDots
  vizIndex={2}
  caption="Modeling Population along with the environment."
/>
...
<WarmingDots
  vizIndex={3}
  caption="Modeling environment and population with two resources."
/>
...
<WarmingDots
  vizIndex={4}
  caption="Including an environmental fragility parameter into the model."
/>
