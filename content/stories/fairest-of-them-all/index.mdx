import CoinFlipHistogram from "./components/CoinFlipHistogram";
import CoinFlipBayesianModel from "./components/CoinFlipBayesianModel";
import CoinFlipTable from "./components/CoinFlipTable";
import RentDivision from "./components/RentDivision";
...
<Figure caption="An interactive probability distribution for flipping coins.">
  <CoinFlipHistogram />
</Figure>
...
<Figure caption="Modeling the likelihood that a coin is fair, given two possible priors.">
...
<Figure caption="Examining the likelihood of TH and HT outcomes for different probabilities.">
  <CoinFlipTable />
</Figure>
...
<Figure caption="Determining a fair division of rent for three roommates." captionMarginTop="-2.8em">
  <RentDivision />
</Figure>
