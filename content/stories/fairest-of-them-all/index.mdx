...
<CoinFlipHistogram caption="An interactive probability distribution
for flipping coins."/>
...
<CoinFlipBayesianModel caption="Modeling the likelihood that a coin is fair, given two possible priors." />
...
<CoinFlipTable caption="Examining the likelihood of TH and HT outcomes for different probabilities." />
...
<RentDivision caption="Determining a fair division of rent for three roommates." />
