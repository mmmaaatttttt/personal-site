...
const selectOptionsHistogram: HistogramOption[] = [
  ...
  },
  {
    ...
    accessor: (d: WeddingData) =>
      d.guests && d.budget !== null ? d.budget / d.guests : null,
    step: 100,
    format: "$.0f",
  },
  {
  ...
  },
  {
    ...
    accessor: (d: WeddingData) =>
      d.spouseAge !== null && d.age !== null ? d.spouseAge - d.age : null,
    step: 2,
    format: ".0f",
  },
];
...
const selectOptionsMap: MapOption[] = [
  ...
  },
  {
    ...
    accessor: (properties: MapProperties) => {
      ...
      return (
        values.reduce(
          (acc: number, cur: WeddingData) => acc + (cur.budget ?? 0),
          0,
        ) / values.length
      );
    },
...
const selectOptionsPieChart: PieOption[] = [
  ...
  },
  {
    ...
    accessor: (data: WeddingData[]) =>
      __pieHelper(data, "budgetPerGuestRanking"),
  },
  {
    value: "expGiven",
