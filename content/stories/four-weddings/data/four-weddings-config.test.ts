...
describe('four-weddings-config logic', () => {
  ...
  describe('Histogram accessors', () => {
    it('calculates budget per guest correctly', () => {
      const budgetPerGuestOption = selectOptions.histogram.find(opt => opt.value === 'budgetPerGuest');
    ...
    it('calculates age gap correctly handling nulls', () => {
      const ageGapOption = selectOptions.histogram.find(opt => opt.value === 'ageGap');
