...
<FourWeddingsVisualization
  vizIndex="1"
  vizType="map"
  caption="Geographic wedding demographics. Hover over a state to learn more."
/>
...
<FourWeddingsVisualization
  vizIndex="2"
  vizType="histogram"
  caption="Basic information for the brides and their weddings."
/>
...
<FourWeddingsVisualization
  vizIndex="3"
  vizType="pie"
  caption="Share of winning weddings by rankings in different categories. First place rankings are blue, second place rankings are green, then orange, then red."
/>
...
<FourWeddingsVisualization
  vizIndex="4"
  vizType="scatter"
  caption="A scatterplot for your enjoyment. Play around with the data at your leisure."
/>
