...
There are probably other conclusions to be drawn from the data, but I'll stop here for now. If you're interested in exploring the data more on your own, [here's](https://github.com/mmmaaatttttt/personal-site/blob/main/data/csv/four_weddings.csv) a link to the raw CSV file. If you notice anything interesting, please let me know!
