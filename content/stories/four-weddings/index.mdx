import FourWeddingsVisualization from "./components/FourWeddingsVisualization";
...
<Figure caption="Geographic wedding demographics. Hover over a state to learn more.">
  <FourWeddingsVisualization vizIndex="1" vizType="map" />
</Figure>
...
<Figure caption="Basic information for the brides and their weddings.">
  <FourWeddingsVisualization vizIndex="2" vizType="histogram" />
</Figure>
...
<StyledTable data={[["Rank", "Point Value"], ["1st", "10"], ["2nd", "6"], ["3rd", "3"]]} />
...
<Figure caption="Share of winning weddings by rankings in different categories. First place rankings are blue, second place rankings are green, then orange, then red.">
  <FourWeddingsVisualization vizIndex="3" vizType="pie" />
</Figure>
...
<Figure caption="A scatterplot for your enjoyment. Play around with the data at your leisure.">
  <FourWeddingsVisualization vizIndex="4" vizType="scatter" />
</Figure>
...
There are probably other conclusions to be drawn from the data, but I'll stop here for now. If you're interested in exploring the data more on your own, [here's](https://github.com/mmmaaatttttt/personal-site/blob/master/src/data/csv/four_weddings.csv) a link to the raw CSV file. If you notice anything interesting, please let me know!
