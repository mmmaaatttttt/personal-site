...
In Blue Prince, slot machines have 4 slots, and there are a total of 8 images that can be drawn. Here are the rules for how the payouts work. 

<Figure caption="Payout rules for the slot machine in Blue Prince. The one symbol missing, a dash mark, has no effect on payouts.">
  <StyledTable
    data={payoutRulesTable}
