...
<Figure caption="Figure 1: Start the animation to watch how often each group hears comments about it from the opposite group.">
...
<Figure caption="Figure 2: Now you can adjust how likely each group is to be offensive towards their own group or the opposite group.">
...
<Figure caption="Figure 3: This simulation is the same as the previous one, but we are now counting more things.">
