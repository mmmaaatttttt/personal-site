import IsoperimetricExplorer from "./components/IsoperimetricExplorer";
import GerrymanderGrid from "./components/SampleGerrymander";
import StandaloneEfficiencyGapTable from "./components/StandaloneEfficiencyGapTable";
import GerrymanderHistoricalMap from "./components/GerrymanderHistoricalMap";
...
![In a cruel twist of fate, Gerry pronounced his last name with a hard 'G.'](../../images/first_gerrymander.png "In a cruel twist of fate, Gerry pronounced his last name with a hard 'G.' (Source: Wikipedia)")
...
<Figure bleed={false} caption="Draw lines around the boxes to create 6 districts of 9 squares each.">
  <GerrymanderGrid />
</Figure>
...
<Figure bleed={false} caption="Drag the sides of the polygon to compare the area of the polygon to the area of the circle.">
...
![The fourth congressional district in Illinois](../../images/il-04.png "The fourth congressional district in Illinois (Source: Wikipedia)")
...
![The 23rd congressional district in California from 2003-2013](../../images/ca-23.png "The 23rd congressional district in California from 2003-2013 (Source: Wikipedia)")

Ohio's 9th district currently has a similar shape; it hugs the southern edge of Lake Erie.

![The 9th congressional district in Ohio](../../images/oh-09.png "The 9th congressional district in Ohio (Source: Wikipedia)")
...
In this system, if your candidate loses, it's easy to think of your vote as being wasted, since the official who won and now represents you likely doesn't _actually_ represent you. But people who vote for losing candidates aren't the only ones whose votes are wasted. Even votes for winners can be considered wasted, if they're in excess of the simple majority needed to squeeze out a win. In other words, if your candidate won by 10,000 votes, one could consider 9,999 of those votes "wasted," since the candidate still would've won even if the margin had been much smaller.
...
<Figure bleed={false} caption="A sample efficiency gap calculation. If no calculation is showing up, please finish drawing your districts above.">
  <StandaloneEfficiencyGapTable />
</Figure>
...
<Figure bleed={false} caption="An exploration of expected advantage due to gerrymandering by state and year.">
...
<ResponsiveIFrame
  src="https://fivethirtyeight.abcnews.go.com/video/embed/56134801"
  heightOverWidth={36 / 64}
/>
