...
<CaptionWrapper caption="Figure 4: Sentiment of every line in an episode. The larger the circle, the more words in the line.">
...
<CaptionWrapper bleed={false} caption="Figure 7: Collocations for Gethard and his callers.">
  <CollocationTable />
</CaptionWrapper>
...
<CaptionWrapper caption="Figure 9: Chris vs. Computer: who said it? This 10 question quiz pulls from 24 examples, so you can play it a few times to see different sentences.">
  <Quiz
