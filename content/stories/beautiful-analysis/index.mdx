...
<Caption caption="Figure 1: Word counts per episode for Gethard and the caller. Tap or mouse over a bar for more details on the episode.">
  <BaMultiBarGraph
    dataType="summary"
...
<Caption caption="Figure 3: Sentiment counts per episode for Gethard and the caller. Use the dropdown to view different ranges of sentiment.">
...
<Caption caption="Figure 4: Sentiment of every line in an episode. The larger the circle, the more words in the line.">
...
<Caption caption="Figure 5: Profanity counts per episode for Gethard and the caller. Tap or mouse over a bar for more details on the episode.">
  <BaMultiBarGraph
    dataType="profanity"
...
<Caption bleed={false} caption="Figure 7: Collocations for Gethard and his callers.">
  <CollocationTable />
</Caption>
...
<Caption caption="Figure 8: Twenty most informative features for
...
<Caption caption="Figure 9: Chris vs. Computer: who said it? This 10 question quiz pulls from 24 examples, so you can play it a few times to see different sentences.">
  <Quiz
