...
import PodcastAllSentiments from "./components/PodcastAllSentiments";
import Quiz from "./components/Quiz";
import BaMultiBarGraph from "./components/BaMultiBarGraph";
import SelectableMultiBarGraph from "./components/SelectableMultiBarGraph";
import SentimentScoreTable from "./components/SentimentScoreTable";
import CommonPhrasesInteractive from "./components/CommonPhrasesInteractive";
import CollocationTable from "./components/CollocationTable";

import { horizontalBarData } from "./data/beautiful-analysis";
...
<Figure caption="Word counts per episode for Gethard and the caller. Tap or mouse over a bar for more details on the episode.">
  <BaMultiBarGraph
    dataType="summary"
...
<SentimentScoreTable
  caption="Sentiment scores for different things Chris Gethard has said."
/>
...
<Figure caption="Sentiment counts per episode for Gethard and the caller. Use the dropdown to view different ranges of sentiment.">
...
<Figure caption="Sentiment of every line in an episode. The larger the circle, the more words in the line.">
...
<Figure caption="Profanity counts per episode for Gethard and the caller. Tap or mouse over a bar for more details on the episode.">
  <BaMultiBarGraph
    dataType="profanity"
...
<Figure
  bleed={false}
  caption="Common phrases for Gethard and his callers.
...
<Figure bleed={false} caption="Collocations for Gethard and his callers.">
  <CollocationTable />
</Figure>
...
<Figure caption="Twenty most informative features for
distinguishing between Gethard and his callers.">
  <HorizontalBarGraph data={horizontalBarData} containerWidth="67%" />
</Figure>
...
<Figure caption="Chris vs. Computer: who said it? This 10 question quiz pulls from 24 examples, so you can play it a few times to see different sentences.">
  <Quiz
