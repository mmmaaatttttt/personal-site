import EconomySimulation from "./components/EconomySimulation";
...
![Shares of Income After Transfers and Federal Taxes, 1979 and 2007](../../images/cbo_income_graph.png "Shares of Income After Transfers and Federal Taxes, 1979 and 2007 (Source: CBO)")
...
<Figure caption="Here's how you might expect our model society to evolve.">
  <EconomySimulation idx={0} />
</Figure>
...
<Figure caption="Here's how our model society actually evolves.">
  <EconomySimulation idx={1} />
</Figure>
...
<Figure caption="Here's a model based on theft and savings.">
  <EconomySimulation idx={2} editSavings={true} />
</Figure>
