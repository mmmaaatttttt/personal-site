...
<EconomySimulation idx={1} caption="Here's how our model society actually evolves." />
...
<EconomySimulation idx={2} caption="Here's a model based on theft and savings." editSavings={true} />
