...
Welcome back, dear reader. If you missed the first part of this story, I strongly encourage you to [read it first]((/stories/dailemma)). 
...
- Let _S_ denote a firm's **S**avings rate expected from automation (this is what we model with our orange slider).
...
The question is what automation rate, call it *a*, the firms will choose to maximize their profit. Set it too low and they can reap more savings by automation. Set it too high and they destroy the demand for their products and services.
...
Another possible solution does not involve government intervention at all. In areas where labor unions still have power, it's possible to force companies to distribute some of this profit to their workers directly. This is [already happening](https://www.ibtimes.com/samsung-ai-chip-workers-secure-massive-bonuses-after-strike-threat-south-korea-3803458); recently, workers in South Korea secured a significant windfall from Samsung. They did it by threatening to strike unless they saw a bigger piece of the AI chip pie.
...
This type of tax is referred to as a [Pigouvian Tax](https://en.wikipedia.org/wiki/Pigouvian_tax), named for the economist who popularized it in the literature. It often comes up in the context of pollution or other negative externalities that aren't accounted for by default in the free market. These types of taxes try to fold these externalities into the market by pricing them. In this case, overshooting the automation rate is a market inefficiency, which a tax like this can help to correct.

Another potential upside to this kind of tax is that the proceeds from it can be used to further shrink the gap between these two automation rates. [Earlier](#train-the-machines-retrain-the-people) we saw how investing in retraining workers could help narrow the gap between the free market and coordinated automation rates. If policymakers use this tax structure and invest the proceeds into those same retraining efforts, it decreases the gap twice over, and in so doing reduces the amount of tax required. 
