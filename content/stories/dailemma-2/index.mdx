...
<Figure caption="Comparing the automation rate calculations. Note that we clamp the result to live between 0 and 1, since companies can't automate less than 0% of their tasks or more than 100% of them.">
