...
<Figure caption="Exploring how income replacement impacts wages and the automation rate chosen by companies.">
  <WelfareChart />
</Figure>
...
Another possible solution the authors consider does not involve government intervention at all. In areas where labor unions still have power, it's possible to force companies to distribute some of this profit to their workers directly. This is [already happening](https://www.ibtimes.com/samsung-ai-chip-workers-secure-massive-bonuses-after-strike-threat-south-korea-3803458); recently, workers in South Korea secured a significant windfall from Samsung. They did it by threatening to strike unless they saw a bigger piece of the AI chip pie.
...
<Figure caption="Giving workers equity back can help buffer a firm's AI aspirations, but it's not as effective as a coordinated approach.">
  <WorkerEquityChart />
</Figure>

You may have noticed from exploration that getting anywhere close to the coordinated outcome is not plausible. For example, even if companies give 100% equity and workers spend 50% of their share back into the market (both very generous assumptions), the optimal automation rate is *much* closer to the free market rate than the coordinated rate. In most real-world scenarios, this structure would likely have only minimal impact to a firm's choice of automation rate.
...
<Figure caption="Adjust the bottom slider to form a coalition amongst the firms. Note that as the coalition size increases, the automation rate gets closer to the fully coordinated one.">
  <CoalitionChart />
</Figure>

As you might expect, if the coalition size is equal to the number of firms, this reduces to the coordination case we've previously discussed. But this model also shows that smaller coalitions also provide a buffer from over-automation.
...
This type of tax is referred to as a [Pigouvian Tax](https://en.wikipedia.org/wiki/Pigouvian_tax), named for the economist who popularized it in the literature. It often comes up in the context of pollution or other negative externalities that aren't accounted for by default in the free market. These types of taxes try to fold these externalities into the market by pricing them. In this case, overshooting the automation rate is a market inefficiency, which in principle a tax like this can help to correct.
