...
<VotingMap
  data={rawVotingData}
  variant="voters"
  caption="Map visualization of population data by year and state."
/>
...
<VotingLineChart
  ...
  states={allStates}
  variant="voters"
  caption="Line representation of population data by year for a fixed state."
/>
...
<VotingTable tableData={voterTableData} caption="Table 1: Average registration and turnout percentages by state." />
...
<VotingBarChart
  data={rawVotingData}
  variant="voters"
  caption="Bar graph of registration and turnout by state."
/>
...
<VotingMap
  data={rawVotingData}
  variant="workers"
  caption="Map visualization of poll worker data by year and state."
/>
...
<VotingLineChart
  ...
  caption="Line representation of poll worker data by year for a fixed state."
/>
...
<VotingPollWorkerAge data={pollWorkerAgeData} states={allStates} caption="Pie chart of poll worker ages, by state and year." />
...
<VotingBarChart
  data={rawVotingData}
  variant="party"
  caption="Exploring the influence of party affiliation on other statistics."
/>
