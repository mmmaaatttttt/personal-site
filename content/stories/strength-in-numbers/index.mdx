import { rawVotingData, voterTableData, pollWorkerAgeData, allStates } from "./data";
import VotingBarChart from "./components/VotingBarChart";
import VotingLineChart from "./components/VotingLineChart";
import VotingMap from "./components/VotingMap";
import VotingPollWorkerAge from "./components/VotingPollWorkerAge";
...
<Figure caption="Map visualization of population data by year and state.">
  <VotingMap data={rawVotingData} variant="voters" />
</Figure>

For a clearer picture of the trend across years within a state, here's a second
representation of the same data:

<Figure caption="Line representation of population data by year for a fixed state.">
  <VotingLineChart data={rawVotingData} states={allStates} variant="voters" />
</Figure>
...
<Figure caption="Table 1: Average registration and turnout percentages by state.">
  <VotingTable tableData={voterTableData} />
</Figure>
...
<Figure caption="Bar graph of registration and turnout by state.">
  <VotingBarChart data={rawVotingData} variant="voters" />
</Figure>
...
<Figure caption="Map visualization of poll worker data by year and state.">
  <VotingMap data={rawVotingData} variant="workers" />
</Figure>

Just like before, we can also dig into trends across years for a single state:

<Figure caption="Line representation of poll worker data by year for a fixed state.">
  <VotingLineChart data={rawVotingData} states={allStates} variant="workers" svgId="state-line-graph-2" />
</Figure>
...
<Figure caption="Pie chart of poll worker ages, by state and year.">
  <VotingPollWorkerAge data={pollWorkerAgeData} states={allStates} />
</Figure>
...
<Figure caption="Exploring the influence of party affiliation on other statistics.">
  <VotingBarChart data={rawVotingData} variant="party" />
</Figure>
...
data [here](https://github.com/mmmaaatttttt/personal-site/blob/main/data/csv/voting_data_2008_2016.csv).
