import OrchardGame from "./components/OrchardGame";
import OrchardGameSimulation from "./components/OrchardGameSimulation";
import OrchardGameHeatData from "./components/OrchardGameHeatData";
import { firstOrchardTable, orchardGameTable } from "./data";
...
![Box Art for First Orchard](../../images/first_orchard.jpg "Box Art for First Orchard (Source: HABA USA)")
...
<OrchardGame caption="An online orchard game." />
...
<OrchardGameSimulation caption="Simulating multiple playthroughs of First Orchard." />
...
<StyledTable data={firstOrchardTable} />
...
![Box Art for Orchard Game](../../images/orchard_game.jpg "Box Art for Orchard Game (Source: HABA USA)")
...
<OrchardGameSimulation
  caption="Simulating multiple playthroughs of Orchard."
...
<StyledTable data={orchardGameTable} />
